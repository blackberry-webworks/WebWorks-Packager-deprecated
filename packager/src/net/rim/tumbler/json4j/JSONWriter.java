...
public class JSONWriter {
    ...
    /**
     * Flag for state checking that a key was placed (if inside an object) Required to be true for a value to be placed in that
     * situation
     */
    ...
    /**
     * Flag used to check the state of this writer, if it has been closed, all operations will throw an IllegalStateException.
     */
     ...
     * @throws IllegalStateException
     *             Thrown if the writer position is not inside an array.
     * @return A reference to this writer.
     */
     ...
     *             Thrown if an IO error occurs on the underlying writer.
     * @throws IllegalStateException
     *             Thrown if the writer position is not inside an object, or if the object has a key placed, but no value.
     * @return A reference to this writer.
     */
     ...
     * @throws IOException
     *             Thrown if an IO error occurs in the underlying writer.
     * @return A reference to this writer.
     */
     ...
     *             Thrown if an IO error occurs on the underlying writer.
     * @throws IllegalStateException
     *             Thrown if the current writer position will not accept a boolean value.
     * @return A reference to this writer.
     */
     ...
     *             Thrown if an IO error occurs on the underlying writer.
     * @throws IllegalStateException
     *             Thrown if the current writer position will not accept a double value.
     * @return A reference to this writer.
     */
     ...
     *             Thrown if an IO error occurs on the underlying writer.
     * @throws IllegalStateException
     *             Thrown if the writer position is in an object and a key has been placed, but a value has not been assigned or
     *             if the writer was already closed.
     */
     ...
     * @throws IOException
     *             Thrown if an error occurs during write.
     */
    ...
    /**
     * Method to generate a string with a particular width. Alignment is done using zeroes if it does not meet the width
     * requirements.
     * 
     * @param s
     *            The string to write
     ...
     * 
     * @param value
     *            The number to write to the JSON output string.
     * @throws IOException
     *             Thrown if an error occurs during write.
     */
     ...
     *             Thrown if an IO error occurs on the underlying writer.
     * @throws JSONException
     *             Thrown if the specified object is not JSONAble.
     */
