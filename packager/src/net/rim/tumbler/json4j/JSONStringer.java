 ...
 * This class exists for API compatibility to other popular JSON parsers.
 */
public class JSONStringer extends JSONWriter {
    ...
    /**
     * Return a string of the stringer contents. This also terminates the Stringer and it cannot be used again. If any errors
     * occur while trying to generate the JSON it returns an empty string.
     */
