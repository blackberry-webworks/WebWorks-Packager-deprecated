...
/**
 * Internaql class for handling the serialization of JSON objects in a verbose format, meaning newlines and indention.
 */
public class SerializerVerbose extends Serializer {
     ...
     * 
     * @param Writer
     *            The writer to serialize JSON to.
     * @param indentSpaces
     *            : How many spaces to indent by (0 to 8). The default indent is the TAB character.
     */
