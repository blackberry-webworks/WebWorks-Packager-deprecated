...
package net.rim.tumbler.json4j;
...
import net.rim.tumbler.json4j.internal.JSON4JStringReader;
import net.rim.tumbler.json4j.internal.JSON4JStringWriter;
import net.rim.tumbler.json4j.internal.NumberUtil;
import net.rim.tumbler.json4j.internal.Parser;
import net.rim.tumbler.json4j.internal.Serializer;
import net.rim.tumbler.json4j.internal.SerializerVerbose;

/**
 * Models a JSON Object.
 * 
 * Extension of Hashtable that only allows String keys, and values which are JSON-able (such as a Java Bean). <BR>
 * <BR>
 * JSON-able values are: null, and instances of String, Boolean, Number, JSONObject and JSONArray. <BR>
 * <BR>
...
public class JSONObject extends Hashtable implements JSONArtifact {
    ...
    public static boolean isValidType( Class clazz ) {
        ...
        if( JSONArray.class == clazz )
            return true;
        if( NumberUtil.isNumber( clazz ) )
            return true;
        if( JSONObject.NULL == clazz )
            return true;
     ...
     * 
     * @param obj
     *            The JSONObject to extract values from.
     * @param keys
     *            The keys to take from the JSONObject and apply to this instance.
     * @throws JSONException
     *             Thrown if a key is duplicated in the string[] keys
     */
    ...
    /**
     * Create a new instance of this class from the provided JSON object string. Note: This is the same as new JSONObject(str,
     * false); Parsing in non-strict mode.
     * 
     * @param str
     ...
     *            The JSON string to parse.
     * @param strict
     *            Whether or not to parse in 'strict' mode, meaning all strings must be quoted (including identifiers), and
    ...
    /**
     * Create a new instance of this class from the data provided from the reader. The reader content must be a JSON object
     * string. Note: The reader will not be closed, that is left to the caller. Note: This is the same as new JSONObject(rdr,
     * false); Parsing in non-strict mode.
     * 
     * @throws JSONException
     *             Thrown when the string passed is null, or malformed JSON..
    ...
    /**
     * Create a new instance of this class from the data provided from the reader. The reader content must be a JSON object
     * string. Note: The reader will not be closed, that is left to the caller.
     * 
     * @param rdr
     *            The reader from which to read the JSON.
     * @param strict
     *            Whether or not to parse in 'strict' mode, meaning all strings must be quoted (including identifiers), and
     *            comments are not allowed.
     * @throws JSONException
    ...
    /**
     * Create a new instance of this class from the data provided from the input stream. The stream content must be a JSON object
     * string. Note: The input stream content is assumed to be UTF-8 encoded. Note: The InputStream will not be closed, that is
     * left to the caller. Note: This is the same as new JSONObject(is, false); Parsing in non-strict mode.
     * 
     * @param is
    ...
    /**
     * Write this object to the stream as JSON text in UTF-8 encoding. Same as calling write(os,false); Note that encoding is
     * always written as UTF-8, as per JSON spec.
     * 
     * @param os
    ...
    /**
     * Convert this object into a stream of JSON text. Same as calling write(writer,false); Note that encoding is always written
     * as UTF-8, as per JSON spec.
     * 
     * @param os
     *            The output stream to write data to.
     * @param verbose
     ...
     * 
     * @param indentDepth
     *            How many spaces to use for each indent level. Should be one to eight. Less than one means no intending, greater
     *            than 8 and it will just use tab.
     * 
     * @throws JSONException
     *             Thrown on IO errors during serialization.
     */
    ...
    /**
     * Write this object to the writer as JSON text in UTF-8 encoding, specifying whether to use verbose (tab-indented) output or
     * not.
     * 
     * @param writer
     *            The writer which to write the JSON text to.
    ...
    /**
     * Write this object to the writer as JSON text, specifying how many spaces should be used for each indent. This is an
     * alternate indent style to using tabs.
     * 
     * @param writer
     *            The writer which to write the JSON text to.
     * @param indentDepth
    ...
    /**
     * Convert this object into a String of JSON text, specifying how many spaces should be used for each indent. This is an
     * alternate indent style to using tabs.
     * 
     * @param indentDepth
     *            How many spaces to use for each indent. The value should be between one to eight. Less than one means no
     *            indenting, greater than 8 and it will just use tab.
     * 
     * @throws JSONException
    ...
    /**
     * Method to obtain the object value for a key. This string-based method is provided for API compatibility to other JSON
     * models.
     * 
     * @param key
     *            The key (attribute) name to obtain the value for.
     * @throws JSONException
     *             Thrown if the noted key is not in the map of key/value pairs.
     */
    ...
    /**
     * Method to obtain the object value for a key. If the key is not in the map, null is returned. This string-based method is
     * provided for API compatibility to other JSON models.
     * 
     * @param key
     *            The key (attribute) name to obtain the value for.
     */
     ...
     * @param key
     *            The key to put in the JSONObject
     * @param value
     *            The value to put in the JSONObject
     * @param includeSuperclass
     *            Boolean indicating that if the object is a JavaBean, include superclass getter properties.
     * @throws JSONException. Thrown
     *             if key is null, not a string, or the value could not be converted.
     */
     ...
     * (non-Javadoc)
     * 
     * @see java.util.HashMap#put(java.lang.Object, java.lang.Object) This is the same as calling put(key, value, true);
     */
     ...
     * @throws JSONException. Thrown
     *             if key is null, not a string, or the value could not be converted to JSON.
     */
     ...
     *            The boolean value.
     * @throws JSONException. Thrown
     *             if key is null or not a string.
     * @return A reference to this object instance.
     */
     ...
     * 
     * @param key
     *            The key/attribute name to set the long to.
     * @param value
     *            The long value.
     * @throws JSONException. Thrown
     *             if key is null or not a string.
     ...
     * 
     * @param key
     *            The key/attribute name to set the collection to.
     * @param value
     *            The Object array to convert to a JSONArray and store.
     * @throws JSONException
     *             Thrown when contents in the Collection cannot be converted to something JSONable.
     * @return A reference to this object instance.
     */
    public JSONObject put( String key, Object[] value ) throws JSONException {
     ...
     *            The Object array to convert to a JSONArray and store.
     * @param includeSuperclass
     *            For values of the Object array which are JavaBeans and are converted, include superclass getter properties.
     * @throws JSONException
     *             Thrown when contents in the Collection cannot be converted to something JSONable.
     * @return A reference to this object instance.
     * 
     *         public JSONObject put(String key, Object[] value, boolean includeSuperclass) throws JSONException { return put
     *         (key, new JSONArray(value), includeSuperclass); }
     */

    /**
     * Utility method to obtain the specified key as a 'boolean' value Only boolean true, false, and the String true and false
     * will return. In this case null, the number 0, and empty string should be treated as false. everything else is true.
     * Provided for compatibility to other JSON models.
     * 
     * @param key
     *            The key to look up. throws JSONException Thrown when the type returned by get(key) is not a boolean instance, or
    ...
    /**
     * Utility method to obtain the specified key as a 'boolean' value Only returns true if the value is boolean true or the
     * string 'true'. All other values return false. Provided for compatibility to other JSON models.
     * 
     * @param key
     *            The key to look up.
     * @return A boolean value (true or false), if the value stored for key is a Boolean, or the strings 'true' or 'false'.
    ...
    /**
     * Utility method to obtain the specified key as a 'double' value Only values of Number will be converted to double, all other
     * types will generate an exception Provided for compatibility to other JSON models.
     * 
     * @param key
     *            The key to look up. throws JSONException Thrown when the type returned by get(key) is not a Double instance, or
    ...
    /**
     * Utility method to obtain the specified key as a 'double' value Only values of Number will be converted to double. all other
     * values will return Double.NaN. Provided for compatibility to other JSON models.
     * 
     * @param key
     *            The key to look up.
     * @return A double value if the value stored for key is an instance of Number.
     ...
     *            The key to look up.
     * @param defaultValue
     *            The default double value to return in case of NaN/null values in map.
     * @return A double value if the value stored for key is an instance of Number.
     */
    ...
    /**
     * Utility method to obtain the specified key as a 'short' value Only values of Number will be converted to short, all other
     * types will generate an exception. Provided for compatibility to other JSON models.
     * 
     * @param key
     *            The key to look up. throws JSONException Thrown when the type returned by get(key) is not a Short instance, or
    ...
    /**
     * Utility method to obtain the specified key as a 'short' value Only values of Number will be converted to short. All other
     * types return 0. Provided for compatibility to other JSON models.
     * 
     * @param key
     *            The key to look up.
    ...
    /**
     * Utility method to obtain the specified key as a 'short' value Only values of Number will be converted to short. Provided
     * for compatibility to other JSON models.
     * 
     * @param key
     *            The key to look up.
     * @param defaultValue
     *            The default value to return in the case of null/nonNumber values in the map.
     * @return A short value if the value stored for key is an instance of Number. 0 otherwise.
     */
    ...
    /**
     * Utility method to obtain the specified key as a 'int' value Only values of Number will be converted to integer, all other
     * types will generate an exception. Provided for compatibility to other JSON models.
     * 
     * @param key
     *            The key to look up. throws JSONException Thrown when the type returned by get(key) is not a Double instance, or
    ...
    /**
     * Utility method to obtain the specified key as a 'int' value Provided for compatibility to other JSON models. Only values of
     * Number will be converted to integer, all other types will return 0.
     * 
     * @param key
     *            The key to look up.
    ...
    /**
     * Utility method to obtain the specified key as a 'int' value Provided for compatibility to other JSON models. Only values of
     * Number will be converted to integer
     * 
     * @param key
     *            The key to look up.
     * @param defaultValue
     *            The default int value to return in case of null/non-number values in the map.
     * @return A int value if the value stored for key is an instance of Number.
     */
    ...
    /**
     * Utility method to obtain the specified key as a 'long' value Only values of Number will be converted to long, all other
     * types will generate an exception. Provided for compatibility to other JSON models.
     * 
     * @param key
     *            The key to look up. throws JSONException Thrown when the type returned by get(key) is not a Long instance, or
    ...
    /**
     * Utility method to obtain the specified key as a 'string' value Only values that can be easily converted to string will be
     * returned. A null will generate an exception. Provided for compatibility to other JSON models.
     * 
     * @param key
     *            The key to look up. throws JSONException Thrown when the type returned by get(key) is null.
     ...
     *            The key to look up.
     * @param defaultValue
     *            The default String value to return in the case of null values in the map.
    ...
    /**
     * Utility method to obtain the specified key as a JSONObject Only values that are instances of JSONObject will be returned. A
     * null will generate an exception. Provided for compatibility to other JSON models.
     * 
     * @param key
     *            The key to look up. throws JSONException Thrown when the type returned by get(key) is not a JSONObject instance.
     ...
     *            The key to look up.
     * @param defaultValue
     *            The default JSONObject to return in the case of null/non JSONObject values in the map.
    ...
    /**
     * Utility method to obtain the specified key as a JSONArray Only values that are instances of JSONArray will be returned. A
     * null will generate an exception. Provided for compatibility to other JSON models.
     * 
     * @param key
     *            The key to look up. throws JSONException Thrown when the type returned by get(key) is not a Long instance, or
     ...
     *            The key to look up.
     * @param defaultValue
     *            The default value to return if the value in the map is null/not a JSONArray.
    ...
    /**
     * Put a key/value pair into the JSONObject, but only if key/value are both not null, and only if the key is not present
     * already. Provided for compatibility to existing models.
     * 
     * @param key
     *            The ket to place in the array
     * @param value
     *            The value to place in the array
     * @return Reference to the current JSONObject.
     * @throws JSONException
     *             - Thrown if the key already exists or if key or value is null
     */
     ...
     * 
     * @param key
     *            The keey (attribute) name to assign to the value.
     * @param value
     *            The value to put into the JSONObject.
     * @return Reference to the current JSONObject.
     * @throws JSONException
    ...
    /**
     * Method to return the number of keys in this JSONObject. This function merely maps to HashMap.size(). Provided for API
     * compatibility.
     * 
    ...
    /**
     * Method to append the 'value' object to the element at entry 'key'. If JSONObject.has(key) returns false, a new array is
     * created and the value is appended to it. If the object as position key is not an array, then a new JSONArray is created and
     * both current and new values are appended to it, then the value of the attribute is set to the new array. If the current
     * value is already an array, then 'value' is added to it.
     * 
     * @param key
     *            The key/attribute name to append to.
     * @param value
     *            The value to append to it.
     * 
     * @throws JSONException
     *             Thrown if the value to append is not JSONAble.
     * @return A reference to this object instance.
     */
     ...
     * 
     * @param names
     *            - A JSONArray containing the a list of key strings. This determines the sequence of values in the result.
     * @return A JSONArray of the values found for the names provided.
     * @throws JSONException
     *             - if errors occur during storing the values in a JSONArray
     */
    ...
    /**
     * Method to test if a key is mapped to null. This method will also return true if the key has not been put in the JSONObject
     * yet,
     * 
     * @param key
     *            The key to test for null.
     * @return true if the key is not in the map or if the value referenced by the key is null, or if the value is the
     ...
     * 
     *         public Enumeration keys() { return this.keys();
     * 
     *         }
     */
    ...
    // /**
    // * Utility function that returns an iterator of all the keys (attributes) of this JSONObject sorted in lexicographic manner
    // (String.compareTo).
    ...
    /**
     * Over-ridden toString() method. Returns the same value as write(), which is a compact JSON String. If an error occurs in the
     * serialization, the return will be of format: JSON Generation Error: [<some error>]
     * 
    ...
    /**
     * Verbose capable toString method. If an error occurs in the serialization, the return will be of format: JSON Generation
     * Error: [<some error>]
     * 
     * @param verbose
     *            Whether or not to tab-indent the output.
     * @return A string of JSON text, if possible.
     */
    ...
    /**
     * Function to return a string of JSON text with specified indention. Returns the same value as write(indentDepth). If an
     * error occurs in the serialization, a JSONException is thrown.
     * 
     * @return A string of JSON text, if possible.
     */
    ...
    /**
     * An simple class provided for API compatibility to other JSON models that 'represents' 'null' in an actual object.
     */
