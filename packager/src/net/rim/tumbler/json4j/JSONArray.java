...
/**
 * Extension of ArrayList that only allows values which are JSON-able. See JSONObject for a list of valid values.
 * 
...
public class JSONArray extends Vector implements JSONArtifact {
     ...
     *            The initial size to define the array as.
     */
    ...
    /**
     * Create a new instance of this class from the provided JSON object string. Note: This is the same as calling new
     * JSONArray(str, false); Parsing in non-strict mode.
     * 
     * @param str
     ...
     *            The JSON array string to parse.
     * @param strict
     *            Boolean denoting if the JSON should be parsed n strict mode, meaning unquoted strings and comments are not
     *            allowed.
     * @throws JSONException
     *             Thrown when the string passed is null, or malformed JSON..
     */
     ...
     * Note: The reader will not be closed, that is left to the caller. Note: This is the same as calling new JSONArray(rdr,
    ...
    /**
     * Create a new instance of this class from the data provided from the input stream. The stream content must be a JSON array
     ...
     * @throws JSONException
     *             Thrown if the index is outside the array bounds.
     */
    ...
    /**
     * Internal function to pad-out the array list Added to mimic expansion behavior of other JSON models.
     * 
     * @param toIndex
     *            Increase the array so that it has up to 'toIndex' as indexable slots.
     */
     ...
     * @see java.util.ArrayList#add(int, java.lang.Object)
     * @throws JSONException
     *             in the case of index out of bounds, etc.
     ...
     * 
     * @param index
     *            The position in the array to place the long.
     * @param value
     *            A long
     * @return A reference to this array instance.
     */
     ...
     * 
     * @param index
     *            The position in the array to place the short.
     * @param value
     *            A short
     * @return A reference to this array instance.
     */
     ...
     * @throws JSONException
     *             if the index is outside the range or if the type at the position was not Boolean or a string of 'true' or
     *             'false'
     */
     ...
     * @return string value.
     * @throws JSONException
     *             if the index is outside the range or if the type at the position was not an object with a toString() function..
     */
     ...
     * null will generate an exception.
     * 
     * @param index
     *            The index to look up. throws JSONException Thrown when the type returned by get(key) is not a JSONObject
     *            instance.
    ...
    /**
     * Utility method to obtain the specified index as a JSONArray Only values that are instances of JSONArray will be returned. A
     * null will generate an exception.
     * 
     * @param index
     *            The index to look up. throws JSONException Thrown when the type returned by get(key) is not a Long instance, or
     ...
     * 
     * @param os
     *            The output stream to write data to. Output stream characters will be serialized as UTF-8.
     * @param verbose
    ...
    /**
     * Convert this object into a String of JSON text, specifying how many spaces should be used for each indent level. Output
     * stream characters will be serialized as UTF-8.
     * 
     * @param indentDepth
    ...
    public Writer write( Writer writer, boolean verbose ) throws JSONException {
        ...
        // MSN reimplement BUFFERED
        /*
         * if (!StringWriter.class.isAssignableFrom(writerClass) && !CharArrayWriter.class.isAssignableFrom(writerClass) &&
         * !BufferedWriter.class.isAssignableFrom(writerClass)) { writer = new BufferedWriter(writer); flushIt = true; }
         */
     ...
     * error occurs in the serialization, the return will be of format: JSON Generation Error: [<some error>]
     * 
     * @throws JSONException
     *             Thrown if an error occurs during JSON generation.
     */
     ...
     *            the array index to get
     * @param defaultValue
     *            the value to return if index is outside the array. v* @return - value or defaultValue
     */
