...
public class Tokenizer {
     ...
     * 
     * @throws IOException
     *             Thrown on IOErrors such as invalid JSON or sudden reader closures.
     */
     ...
     * 
     * @throws IOException
     *             Thrown if unexpected read error occurs or invalid character encountered in JSON string.
     */
    ...
    /**
     * Method to read out comments in the 'JSON'. JSON normally should not have comments, but I guess we need to be more
     * permissive to make some Crockford code happy.
     */
     ...
     * 
     * @throws IOException
     *             Thrown on unterminated strings, invalid characters, bad escapes, and so on. Basically, invalid JSON.
     */
     ...
     * 
     * (-)(1-9)(0-9)* : decimal (-)0(0-7)* : octal (-)0(x|X)(0-9|a-f|A-F)* : hex [digits][.digits][(E|e)[(+|-)]digits]
     * 
     * @returns The number as the wrapper Java Number type.
     * 
     * @throws IOException
     *             Thrown in invalid numbers or unexpected end of JSON string
     * */
    private Object readNumber() throws IOException {
        ...
        try {
            ...
            /**
             * We have to check for the exponential and treat appropriately Exponentials should be treated as Doubles.
             */
     ...
     * 
     * @param c
     *            The character to check for being a OCTAL digit.
     */
     ...
     * 
     * @param c
     *            The character to check for being a digit.
     */
    ...
    private String readIdentifier() throws IOException {
        ...
        if( this.strict ) {
            while( ( -1 != lastChar )
                    && ( ( Character.isUpperCase( (char) lastChar ) ) || ( Character.isLowerCase( (char) lastChar ) ) ) ) {
                sb.append( (char) lastChar );
                readChar();
            }
        } else {
     ...
     * 
     * @throws IOEXception
     *             Thrown when underlying reader throws an error.
     */
