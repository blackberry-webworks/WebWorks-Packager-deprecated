...
public class WidgetConfig implements IWidgetConfig {
     ...
     * </pre>
     * 
     * This Pattern provides a capturing group for each part of the version string. For example, capturing groups for a version
     * string of <code>"4.0.1.96"</code> are "4", "0", "1", and "96".
     */
    ...
    public void validate() {
        if( _versionParts == null || getVersion().length() == 0 ) {
            Logger.logMessage( LogType.WARNING, VALIDATION_CONFIGXML_MISSING_VERSION );
    ...
    /**
     * Returns the version string. (Example: <code>"4.0.1.96"</code>). Only the defined parts are included in the result. As an
     * example, a result for a 2-part version looks like this: <code>"4.0"</code>.
     * 
    ...
    /**
     * Returns the specified parts of the version string, starting from the specified index (inclusive). As an example, for a
     * version string of <code>"4.0.1.96"</code> the result of <code>getVersionParts(1)</code> looks like this:
     * <code>"0.1.96"</code>. Returns an empty string if <code>beginIndex</code> is greater than or equal to the value returned by
     * <code>getNumVersionParts()</code>.
     * 
     * @param beginIndex
     *            the beginning index, inclusive.
     * 
     * @return the specified parts of the version string, starting from the specified index (inclusive).
     */
    ...
    /**
     * Returns the specified parts of the version string, starting from the specified index (inclusive) and extending to the
     * specified end (exclusive). As an example, for a version string of <code>"4.0.1.96"</code> the result of
     * <code>getVersionParts(1,3)</code> looks like this: <code>"0.1"</code>. Returns an empty string if <code>beginIndex</code>
     * is greater than or equal to the value returned by <code>getNumVersionParts()</code>.
     * 
     * @param beginIndex
     *            the beginning index, inclusive.
     * @param endIndex
    ...
    /**
     * Returns the number of defined parts in the version string. For example, <code>"4.0.1.96"</code> has 4 defined parts, and
     * <code>"4.0"</code> has 2 defined parts.
     */
    public int getNumVersionParts() {
        return _versionParts == null ? 0 : _versionParts.length;
    }
    ...
    public Vector< String > getIconSrc() throws ValidationException {
        if( _iconSrc.toString().length() > 2
                && !( _iconSrc.firstElement().toString().startsWith( FILE_EXT_L_ICON ) || _iconSrc.firstElement().toString()
                        .startsWith( FILE_EXT_U_ICON ) )
                && !( _iconSrc.firstElement().toString().toLowerCase().endsWith( FILE_EXT_L_PNG ) ) ) {
            throw new ValidationException( EXCEPTION_INVALID_ICON_FILE_TYPE );
        }
        return _iconSrc;
    }
    ...
    public void setVersion( String version ) throws ValidationException {
        if( SessionManager.getInstance().isVerbose() ) {
            Logger.logMessage( LogType.INFO, PROGRESS_VALIDATING_CONFIG_XML_WIDGET_VERSION );
        }
    ...
    public void setLoadingScreenColour( String screenColour ) throws ValidationException {

        if( screenColour != null ) {
            if( SessionManager.getInstance().isVerbose() ) {
                Logger.logMessage( LogType.INFO, PROGRESS_VALIDATING_CONFIG_XML_LOADINGSCREEN_COLOR );
            }
            ...
            if( !matcher.matches() ) {
                throw new ValidationException( EXCEPTION_CONFIGXML_LOADINGSCREEN_COLOUR );
            }
        }
    ...
    public void setAccessTable( Hashtable< WidgetAccess, Vector< WidgetFeature >> table ) {
        _accessTable = table;
    }
