...
//        ( new File( outputDir + FILE_SEP + archiveName + ".rapc" ) ).delete();
    ...
    public void generateProjectFiles( String sourceDir, String codName, String appName, String appVersion, String appVendor,
        ...
        if( appVendor != null ) {
            writer.write( "Vendor=" + appVendor + EOL );
        }
    ...
    public void copyOutputsFromSource() throws Exception {
        ...
        copyFiles( new File( sourceFolder ), outputDir );
    }
    
    /**
     * Copies output files from source for the specified file extensions.
     * 
     * @param standardOutputs
     *            file extensions for standard outputs.
     * @param otaOutputs
     *            file extensions for OTA outputs.
     */
    public void copyOutputsFromSource( String[] standardOutputs, String[] otaOutputs ) throws Exception {
